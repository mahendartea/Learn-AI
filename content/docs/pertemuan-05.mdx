...
$$
	heta^* = rac{C_{	ext{FP}}}{C_{	ext{FP}} + C_{	ext{FN}}}
$$
...
Dataset [NSE-TATAGLOBAL11.csv](file:///Users/mac/code/Learn-AI/public/data/NSE-TATAGLOBAL11.csv) telah tersedia di direktori portal `/data/NSE-TATAGLOBAL11.csv`. Skrip Python berikut mereplikasi alur eksperimen perbandingan model dari materi pelatihan:
